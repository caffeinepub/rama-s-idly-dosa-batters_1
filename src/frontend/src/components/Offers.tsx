...
const offers = [
  {
    ...
    description:
      "Get 10% off on your very first order. Use code WELCOME10 at checkout.",
    tag: "New Customers",
    tagColor: "#7B2D2D",
  },
  {
    ...
    description:
      "Order 5 kg or more and save ₹20 per kg. Perfect for families and events.",
    tag: "Bulk Orders",
    tagColor: "#D4820A",
  },
  {
    ...
    description:
      "Subscribe for weekly delivery and get 1 free pack every month. Never run out!",
    tag: "Subscribe & Save",
    tagColor: "#7B2D2D",
  },
];
    ...
    <section id="offers" aria-label="Special Offers" className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Decorative circles */}
          <div
            className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10 -translate-y-1/2 translate-x-1/2 bg-white"
            aria-hidden="true"
          />
          <div
            className="absolute bottom-0 left-0 w-48 h-48 rounded-full opacity-10 translate-y-1/2 -translate-x-1/2 bg-white"
            aria-hidden="true"
          />
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-white/90 text-base font-body max-w-md">
                  We're available on the Zomato Partner App. Order fresh batters
        ...
        <article
          ...
          style={{
            background:
              "linear-gradient(135deg, #3D1212 0%, #7B2D2D 45%, #D4820A 100%)",
            borderRadius: "8px",
          }}
        >
          {/* Decorative circles */}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              <div
                className="w-14 h-14 bg-white/20 flex items-center justify-center shrink-0"
              ...
              <div>
                <div
                  className="inline-flex items-center gap-2 bg-white/20 rounded-full px-3 py-1 mb-2"
                  aria-hidden="true"
                >
                ...
                <p className="text-white/85 text-base font-body">
                  Buy 2 kg of any batter and get ½ kg batter absolutely FREE!
                  Every Sunday only.
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {offers.map((offer) => (
            ...
            >
              ...
              <h3 className="font-display text-xl font-bold text-spice mb-3">
                {offer.title}
              </h3>
              <p className="text-ink-light text-sm leading-relaxed font-body">
                {offer.description}
              </p>
              <a
                href="https://wa.me/918143497999"
