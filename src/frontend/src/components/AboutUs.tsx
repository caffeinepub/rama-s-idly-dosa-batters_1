...
const values = [
  {
    ...
    title: "Fresh",
    description:
      "Made fresh daily with the finest ingredients sourced locally.",
  },
  {
    icon: Droplets,
    title: "Natural",
  ...
  },
  {
    ...
    title: "Hygienic",
    description:
      "Prepared in a spotlessly clean kitchen with strict hygiene standards.",
  },
  {
    icon: Award,
    title: "Authentic",
    description:
      "Traditional stone-ground recipes for that genuine home-made taste.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-6 text-ink-light max-w-2xl mx-auto text-base md:text-lg leading-relaxed font-body">
            Bringing the authentic taste of South India to your kitchen since
            2025.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-ink-light leading-relaxed mb-4 font-body">
              Rama's Home Foods Idly and Dosa Batters was founded on{" "}
              <strong>01-08-2025</strong> with a passion for authentic South
              Indian cuisine. Since day one, we have been running successfully —
              committed to hygiene, quality raw materials, and a completely
              authentic style that brings the real taste of home to your table.
            </p>
            <p className="text-ink-light leading-relaxed mb-4 font-body">
              Every batch is prepared with carefully selected rice and lentils,
              stone-ground to the perfect consistency, and{" "}
              <strong>naturally fermented</strong> to develop that
              characteristic tangy flavour that makes South Indian breakfasts so
              special.
            </p>
            <p className="text-ink-light leading-relaxed mb-6 font-body">
              We use <strong>Pure RO Water</strong> and maintain strict hygiene
              throughout our process. No salt, no soda, no preservatives — just
              pure, authentic taste the way it was always meant to be.
            </p>

            {/* Quality Pillars */}
            <ul
              className="grid grid-cols-2 gap-2 list-none m-0 p-0"
              aria-label="Quality commitments"
            >
        ...
        {/* Value Cards */}
        <ul
          className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 list-none m-0 p-0"
        ...
        >
          {values.map(({ icon: Icon, title, description }) => (
            ...
            >
              ...
              <h4 className="font-display text-lg font-bold text-spice mb-2">
                {title}
              </h4>
              <p className="text-sm text-ink-light leading-relaxed font-body">
                {description}
              </p>
            </li>
          ))}
