...
export default function Footer() {
  ...
  const appId = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "ramas-batters",
  );
    ...
    <footer style={{ backgroundColor: "#1A0A0A" }} className="text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <p className="font-display font-bold text-lg leading-tight text-saffron">
                  Rama's Home Foods
                </p>
                <p className="text-xs text-white/60 font-body leading-tight">
                  Idly and Dosa Batters
                </p>
              </div>
            </div>
            <p className="text-white/70 text-sm leading-relaxed font-body mb-5">
              Authentic South Indian batters made fresh daily with traditional
              recipes. Est. 01-08-2025 — running successfully with hygiene &amp;
              quality.
            </p>
            {/* Order Links */}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-saffron mb-5 text-base uppercase tracking-wide">
              Quick Links
            </h4>
            ...
            <address className="not-italic">
              <ul className="space-y-4 list-none m-0 p-0">
                <li className="flex items-start gap-3">
                  <MapPin
                    className="w-4 h-4 text-saffron mt-0.5 shrink-0"
                    aria-hidden="true"
                  />
                  <span className="text-white/70 text-sm font-body leading-relaxed">
                    21-9-222 Madhura Nagar Railway Station, Main Rd, Saibaba
                    Colony, cross, Vijayawada, Andhra Pradesh 520011
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <MapPin
                  ...
                  />
                  <div>
                    <p className="text-saffron/80 text-xs font-body font-semibold mb-0.5 uppercase tracking-wide">
                      Marketing Address
                    </p>
                    <span className="text-white/70 text-sm font-body leading-relaxed">
                      Rama's Home Foods
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/50 text-xs font-body text-center sm:text-left">
            © {new Date().getFullYear()} Rama's Home Foods Idly and Dosa
            Batters. All rights reserved.
          </p>
      ...
      <Dialog open={sitemapOpen} onOpenChange={setSitemapOpen}>
        <DialogContent
          ...
          style={{
            backgroundColor: "oklch(0.99 0.005 60)",
            borderRadius: "12px",
          }}
        >
