...
const sections: SitemapSection[] = [
  {
    ...
    label: "Home",
    description:
      "Welcome to Rama's Home Foods — fresh, authentic South Indian batters",
    icon: Home,
    color: "#D4820A",
  },
  {
    ...
    label: "Products",
    description:
      "Idly Batter, Dosa Batter, Vada Batter, Ragi Idly & Ragi Dosa Batters",
    icon: ShoppingBag,
    color: "#C0392B",
  },
  {
  ...
  },
  {
    ...
    label: "Why Choose Us",
    description:
      "Pure RO Water, No Preservatives, Natural Fermentation, No Salt/Soda",
    icon: Star,
    color: "#C0392B",
  },
  {
  ...
  return (
    <div className="p-2">
      ...
      <div
        ...
        style={{ borderColor: "oklch(0.35 0.14 20 / 0.15)" }}
      >
        <div
        ...
        <div>
          <h2 className="font-display text-xl font-bold text-spice">
            Site Navigation
          </h2>
      ...
      {/* Footer note */}
      <p
        className="text-center text-xs text-ink-light font-body mt-5 pt-4 border-t"
        style={{ borderColor: "oklch(0.35 0.14 20 / 0.10)" }}
      >
