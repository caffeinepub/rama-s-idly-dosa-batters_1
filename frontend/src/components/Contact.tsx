import { MapPin, Phone, Clock, MessageCircle, PhoneCall, CheckCircle, Droplets, FlaskConical, Leaf, Ban, ExternalLink, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              <p className="mt-2 text-xs text-ink-light font-body">
                Est. 01-08-2025 · Running successfully with hygiene &amp; quality
              </p>
            </div>
            ...
            >
              ...
              <h4 className="font-display font-bold text-spice mb-1 text-sm">Address</h4>
              <address className="text-ink-light text-sm font-body leading-relaxed not-italic">
                21-9-222 Madhura Nagar Railway Station,<br />
                Main Rd, Saibaba Colony, cross,<br />
            ...
            >
              ...
              <h4 className="font-display font-bold text-spice mb-1 text-sm">Marketing Address</h4>
              <address className="text-ink-light text-sm font-body leading-relaxed not-italic">
            ...
            >
              ...
              <h4 className="font-display font-bold text-spice mb-1 text-sm">Email</h4>
              <a
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <h4 className="font-display font-bold text-spice mb-1 text-sm">Phone</h4>
                <a
              ...
              >
                ...
                <h4 className="font-display font-bold text-spice mb-1 text-sm">Customer Care</h4>
                <a
            ...
            >
              ...
              <h4 className="font-display font-bold text-spice mb-1 text-sm">Business Hours</h4>
            ...
            <div
              ...
              style={{ borderRadius: '8px' }}
            >
              <h4 className="font-display font-bold text-spice mb-3 text-sm">Our Quality Promise</h4>
              <div className="grid grid-cols-2 gap-2" role="list" aria-label="Quality highlights">
          ...
          <div className="flex flex-col gap-4">
            <div
              ...
              style={{ borderColor: 'oklch(0.35 0.14 20 / 0.2)', borderRadius: '8px', minHeight: '460px' }}
            >
              <iframe
            ...
            <a
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLAnchorElement).style.backgroundColor = 'oklch(0.35 0.14 20 / 0.12)';
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLAnchorElement).style.backgroundColor = 'oklch(0.35 0.14 20 / 0.06)';
              }}
            ...
            >
              ...
              <ExternalLink className="w-4 h-4 text-spice/60" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
