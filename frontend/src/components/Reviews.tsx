...
const reviews = [
  {
    ...
    location: 'Vijayawada',
    rating: 5,
    review: 'The idly batter is absolutely perfect! My family loves the soft, fluffy idlies. The taste is exactly like home-made. Highly recommend!',
    initials: 'PS',
  },
  {
    name: 'Ravi Kumar',
    location: 'Vijayawada',
    rating: 5,
    review: 'Best dosa batter in Vijayawada! The dosas come out crispy and golden every single time. Fresh delivery right to my door.',
    initials: 'RK',
  },
  {
    name: 'Lakshmi Devi',
    location: 'Vijayawada',
    rating: 5,
    review: "I switched to Rama's batters 6 months ago and never looked back. The ragi idly batter is a game-changer for healthy breakfasts!",
    initials: 'LD',
  },
  {
    name: 'Suresh Babu',
    location: 'Vijayawada',
    rating: 5,
    review: 'Excellent quality and very hygienic. The vada batter makes perfect crispy vadas. Great service and always on time delivery.',
    initials: 'SB',
  },
];
          ...
          {reviews.map(review => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-auto pt-4 border-t border-cream-dark">
                <div
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0 bg-spice"
                >
                  {review.initials}
                </div>
                <div>
                  ...
                  <p className="text-xs text-ink-light font-body">{review.location}</p>
                </div>
              </div>
            </div>
          ))}
